...
function Documentation({ formData, handleChange }) {
    ...
    const handleFileChange = (e) => {
        ...
        handleChange(e, 'CBO', 'documents', updatedFiles);
    };    
            ...
            <div className='form-fields'>
                <label htmlFor="dropzone-file" className='file-dropzone'>
                    <div className='file-content'>
                        ...
                        <p className='file-info'>SVG, PNG, JPG</p>
                    </div>
                    <input id="dropzone-file" type="file" className='hidden' onChange={handleFileChange} multiple name="documents" />
                </label>
            </div>
